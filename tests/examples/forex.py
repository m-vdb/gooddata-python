...
class Forex(Dataset):
    ...
    id = ConnectionPoint(title='Id', dataType='VARCHAR(32)', folder='Forex')
    time = Date(title='TIME', datetime=True, folder='Forex', schemaReference='Forex', format='yyyy-MM-dd HH:mm:SS')
    volume = Fact(title='VOLUME', dataType='INT', folder='Forex')
